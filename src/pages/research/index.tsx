        ...
        <div className='flex-col w-full h-fit bg-gray-800'>
          ...
          <div className='flex w-full h-fit'>
            <div className='grid grid-cols-2 w-full bg-gray-900 xl:mx-48 mt-12 mb-32 py-24 px-16 xl:px-32 gap-x-16 gap-y-24'>
              <div className='flex-col h-[240px] sm:h-[420px]'>
                <div className='flex bg-[url("/pr_img/vivy.png")] bg-cover bg-center w-full h-5/6 transition ease-in-out duration-300 hover:scale-110 hover:bg-opacity-50' id='project_img'>
                  <div className='flex-col w-full h-full p-12 backdrop-brightness-50 backdrop-blur-sm space-y-3 opacity-0 hover:opacity-100' id='project_desc'>
                    <p className='text-xl xl:text-2xl font-normal'>VIVYNet, Text-to-Music Generative AI Model</p>
                ...
                <p className='flex h-1/6 w-full text-center justify-center text-xs sm:text-xl items-center' id='project_name'>VIVYNet, Text-to-Music Generative AI Model</p>
              </div>
              <div className='flex-col h-[240px] sm:h-[420px]'>
                <div className='flex bg-[url("/pr_img/air.webp")] bg-center bg-cover w-full h-5/6 transition ease-in-out duration-300 hover:scale-110 hover:bg-opacity-50' id='project_img'>
                  <div className='flex-col w-full h-full p-12 backdrop-brightness-50 backdrop-blur-sm space-y-3 opacity-0 hover:opacity-100' id='project_desc'>
                    <p className='text-xl xl:text-2xl font-normal'>Layer.ai Air Quality Prediction</p>
                ...
                <p className='flex h-1/6 w-full text-center justify-center text-sm sm:text-xl items-center' id='project_name'>Layer.ai Air Quality Prediction</p>
              </div>
              <div className='flex-col h-[240px] sm:h-[420px]'>
                <div className='flex bg-[url("/pr_img/maplebot.png")] bg-cover bg-left w-full h-5/6 transition ease-in-out duration-300 hover:scale-110 hover:bg-opacity-50' id='project_img'>
                  <div className='flex-col w-full h-full p-12 backdrop-brightness-50 backdrop-blur-sm space-y-3 opacity-0 hover:opacity-100' id='project_desc'>
                    <p className='text-xl xl:text-2xl font-normal'>MapleBot</p>
                ...
                <p className='flex h-1/6 w-full text-center justify-center text-sm sm:text-xl items-center' id='project_name'>MapleBot</p>
              </div>
            </div>
          </div>
